...
export function dashboardVoiceState(state: VoiceState): void {
  setBrainState(state);
}

export function dashboardResponse(text: string): void {
  setLastResponse(text);
}

export function dashboardActivity(item: string): void {
  addActivity(item);
}
